...
//                                .padding(.bottom, 16) // Add some padding below the header
//
//                            // 剧集列表
...
//                            }
//                        }
//                        .background(Color.black) // Set background for the whole scrollable content
//                        .onAppear {
//                            // 确保在视图出现时加载数据
...
//                        }
//                    }
//                    .background(Color.black.edgesIgnoringSafeArea(.all)) // Ensure background covers safe areas
//                    .refreshable {
//                        isRefreshing = true
//                        viewModel.refreshEpisodes()
//                        isRefreshing = false
